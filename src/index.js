...
function showTemp(response) {
  ...
  descriptionElement.innerHTML = response.data.weather[0].description;
   if (descriptionElement.innerHTML.match(/^(rain|thunderstorm|shower rain|moderate rain|scattered showers|showers|light rain|light intensity shower rain)$/)){
    document.querySelector("#player").innerHTML=`<p><iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/37i9dQZF1DXbvABJXBIyiY?utm_source=generator&theme=0" width="100%" height="100" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe></p>`;
  };
